...
def create_fastwam_hierarchical(
    ...
    return FastWAM_Hierarchical.from_wan22_pretrained(
        ...
        loss_lambda_video=float(loss.get("lambda_video", 1.0)),
        loss_lambda_action=float(loss.get("lambda_action", 1.0)),
        hierarchical_action_horizon=int(hierarchical_action_horizon),
        ...
        hierarchical_high_condition_mode=str(hierarchical_high_condition_mode),
        hierarchical_dynamic_skip=bool(hierarchical_dynamic_skip),
