...
STAGE="${H3_WORKSPACE}/outputs/h3-lingbot-history/history16_from_s5000_s3000_step000500.pt"
OUTPUT_DIR="${H3_WORKSPACE}/outputs/eval-lingbot-history/history_step000500_goal_task3_trial0_replan16"
