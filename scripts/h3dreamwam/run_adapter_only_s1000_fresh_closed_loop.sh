...
STAGE="${H3_WORKSPACE}/outputs/h3-lingbot-shared-sync-v2-adapter-only-s5000-fresh/shared_sync_v2_adapter_only_s5000_fresh_step001000.pt"
OUTPUT_DIR="${H3_WORKSPACE}/outputs/eval-h3-lingbot-shared-sync-v2-adapter-only-s5000-fresh/step001000_goal_task3_trial0_replan32"
