...
STAGE="${H3_WORKSPACE}/outputs/h3-lingbot-shared/quantile_flowweight_lr1e5_tail2_s10000_step004000.pt"
OUTPUT_DIR="${H3_WORKSPACE}/outputs/eval-lingbot-shared/scale-s10000/tail2_step04000_goal_task3_trial0_replan16"
