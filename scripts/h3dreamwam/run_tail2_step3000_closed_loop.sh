...
STAGE="${H3_WORKSPACE}/outputs/h3-lingbot-shared/quantile_flowweight_lr1e5_tail2_s10000_step003000.pt"
OUTPUT_DIR="${H3_WORKSPACE}/outputs/eval-lingbot-shared/scale-s10000/tail2_step03000_goal_task3_trial0"
